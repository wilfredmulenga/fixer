    ...
    return (
        <div>
            <div className="blueBackground">
                ...
                <div className="flex pb-5" style={{ textAlign: 'center', paddingBottom: 50 }}>
                    <h3 className="titles heading" style={{ color: 'white', fontSize: 40, fontStyle: 'bold' }}>How It Works</h3>
                    ...
                    <div className="mt-5 row d-flex justify-content-start">
                        <div className=" row col-md-5  offset-md-2 col-sm-12 mb-3">
